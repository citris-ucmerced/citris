...
Save an image to associate the article in images/news with the same name as the article you are writing.

Copy HTML from an existing article, and rewrite it to make it specific to the article you are writing.
